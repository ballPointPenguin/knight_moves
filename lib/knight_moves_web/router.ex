defmodule KnightMovesWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {KnightMovesWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: KnightMovesWeb.Telemetry
    end
  end
